...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("patbern")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("pat pass")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Victor")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Patrick")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Dml")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Blogger")
